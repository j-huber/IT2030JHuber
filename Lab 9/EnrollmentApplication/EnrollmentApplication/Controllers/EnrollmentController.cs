...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        {
            var course = GetCourses(q);
            return PartialView("_CourseSearch", course);
        }

        private List<Course> GetCourses(string searchString)
        {
            return db.Courses.Where(a => a.CourseTitle.Contains(searchString) || a.CourseDescription.Contains(searchString)).ToList();
        }
