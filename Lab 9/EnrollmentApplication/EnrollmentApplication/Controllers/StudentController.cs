...
namespace EnrollmentApplication.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,StudentLastName,StudentFirstName,Age,Address1,Address2,City,Zipcode,State")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,StudentLastName,StudentFirstName,Age,Address1,Address2,City,Zipcode,State")] Student student)
        {
            if (ModelState.IsValid)
            {
